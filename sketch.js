...
function preload(){
    ...
    planet1I = loadImage('jupiterimg.png');
    planet2I = loadImage('p2.png');
    planet3I = loadImage('planet1.png');
    planet4I = loadImage('planet2.png');
    cometI = loadImage('comet.jpg');
    meteorI = loadImage('meteor.jpg');
    asteroidI = loadImage('asteroid.jpg');
    rocketI = loadImage('rocket.jpg');
